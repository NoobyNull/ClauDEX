...
3. Inform the user that the conversation has been stashed and can be resumed with `/claudex:resume`
...
- `/claudex:stash auth refactor` → stashes current thread with label "auth refactor"
- `/claudex:stash` → stashes with auto-generated label based on the conversation topic
